...
func newClientConn(
	...
	enableDatagrams bool,
	additionalSettings map[uint64]uint64,
	streamHijacker func(FrameType, ConnectionTracingID, *quic.Stream, error) (hijacked bool, err error),
	uniStreamHijacker func(StreamType, ConnectionTracingID, *quic.ReceiveStream, error) (hijacked bool),
	maxResponseHeaderBytes int,
	disableCompression bool,
	logger *slog.Logger,
) *ClientConn {
...
func (c *ClientConn) handleBidirectionalStreams(streamHijacker func(FrameType, ConnectionTracingID, *quic.Stream, error) (hijacked bool, err error)) {
	for {
